...
export function Github({ size = 18, className }: P) {
  return (
...
export function Linkedin({ size = 18, className }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
...
export function Kaggle({ size = 18, className }: P) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18.83 23.6c-.02.1-.1.15-.26.15h-3.3c-.18 0-.34-.08-.48-.25l-5.45-6.94-1.52 1.45v5.36c0 .25-.13.38-.38.38H4.86c-.25 0-.38-.13-.38-.38V.38c0-.25.13-.38.38-.38h2.58c.25 0 .38.13.38.38v13.7l6.6-6.68c.17-.17.34-.26.5-.26h3.44c.14 0 .23.06.27.17.04.13.02.23-.06.3l-6.94 6.72 7.13 8.93c.1.12.13.23.07.34z" />
    </svg>
  )
}
